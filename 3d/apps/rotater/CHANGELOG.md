...
### Fixed
- **Crop mode toggle behavior**: clicking the crop frame icon toggles crop mode on/off. First click activates crop mode; second click (while crop is active) applies the crop framing and exits crop mode. This is the primary workflow for composing an export crop and exiting the overlay.
