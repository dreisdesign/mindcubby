...
- Latest updates documented in `CHANGELOG.md` include repeated-refresh camera restore stabilization, zoom refresh persistence hardening on page-exit lifecycle events, add-to-plate level/reframe auto-framing, inspect overlay measurement stability improvements, and About panel header/link visual polish.
