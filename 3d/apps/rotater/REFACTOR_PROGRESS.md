...
1. Export preview pipeline args-bundle extraction
- Target: reduce argument fan-out for pipeline invocation with a stable dependency bundle
- Candidate module: modules/export-preview-pipeline-bundle.js
