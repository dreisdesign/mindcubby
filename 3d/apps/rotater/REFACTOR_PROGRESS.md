...
49. Right-pan interaction extraction
- Module: [modules/right-pan-lock.js](modules/right-pan-lock.js)
- Scope: right-pan vertical-lock and shift-pan interaction controller
...
51. Export progress overlay extraction
- Module: [modules/export-progress-overlay.js](modules/export-progress-overlay.js)
- Scope: export progress overlay element show/update/hide helper orchestration
...
53. Export busy-state controls extraction
- Module: [modules/export-busy-state.js](modules/export-busy-state.js)
- Scope: export button disabled-state and overlay-show/hide helper orchestration
...
55. Export download helper extraction
- Module: [modules/export-download.js](modules/export-download.js)
- Scope: export blob download and URL revoke helper orchestration
...
59. MP4 encoder queue wait extraction
- Module: [modules/export-mp4-encoder-queue.js](modules/export-mp4-encoder-queue.js)
- Scope: MP4 encoder queue wait and busy-status notice helper orchestration
