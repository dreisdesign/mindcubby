...
RECIPE_NAME = "01. Pen_Holder_Secret"
...
# List your parts. 
# You can now use JUST the filename (e.g. "top--flat--01--xs-18.0mm--ribbed.stl")
# The script will search your ALIGNED-STLS folder automatically.
ASSEMBLY_PARTS = [
    "top--tube--02--sm-30.4mm--ribbed.stl",
    "middle--flat--05--xl-67.6mm--ribbed.stl",
