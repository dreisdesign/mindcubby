...
GECODER is a browser-based tool that helps you generate 3D printing specifications from G-code files. This Privacy Policy explains how the application handles your data.
...
**GECODER collects ZERO personal data.** We do not:
...
GECODER is a **100% client-side application:**
...
GECODER is hosted on **GitHub Pages**, which means:
...
- The GECODER HTML, CSS, and JavaScript files
- Your browser history
- Any files you download (to your Downloads folder)

These are normal browser functions and fall under your browser's privacy controls, not GECODER's.
...
- **File Download:** Your browser downloads a `.md` file to your local device. GECODER does not receive notification of this action.
...
- ❌ Extract your data from GECODER (no data stored remotely)
- ❌ Track your usage (no tracking code)
- ❌ Compromise your data through GECODER (no server to hack)
...
GECODER does not share data with, sell data to, or use services from third parties for data processing. The only exception is:
...
If we make changes to this Privacy Policy, we will update the "Last Updated" date at the top of this document. Since GECODER does not collect data, major changes are unlikely, but we may clarify or expand this policy.
...
This Privacy Policy is provided in good faith to ensure transparency. GECODER complies with:
...
**Your G-code files and data belong to you and stay with you.** GECODER is a tool that runs entirely on your device. We do not see, store, or use your data in any way. Your privacy is not compromised by using GECODER.

---

*GECODER – Privacy-First 3D Printing Specification Generator*
