import"./iframe-WougcEML.js";import"./preload-helper-PPVm8Dsz.js";function Z(s={}){const u=s&&s.onlyFlavor?String(s.onlyFlavor):"",p={global:{"--palette-base-100":"Surface","--palette-base-500":"Outline","--palette-base-800":"Text","--palette-green-500":"Success","--palette-yellow-500":"Warning","--palette-red-500":"Error"},vanilla:{"--palette-vanilla-100":"Surface","--palette-vanilla-200":"Background","--palette-vanilla-300":"Primary Lighter","--palette-vanilla-500":"Primary","--palette-vanilla-800":"Primary Darker","--palette-vanilla-900":"Background Darkest"},blueberry:{"--palette-blueberry-100":"Surface","--palette-blueberry-200":"Background","--palette-blueberry-300":"Primary Lighter","--palette-blueberry-500":"Primary","--palette-blueberry-800":"Primary Darker","--palette-blueberry-900":"Background Darkest"},strawberry:{"--palette-strawberry-100":"Surface","--palette-strawberry-200":"Background","--palette-strawberry-300":"Primary Lighter","--palette-strawberry-500":"Primary","--palette-strawberry-800":"Primary Darker","--palette-strawberry-900":"Background Darkest"}},y=(l,k,c,h)=>{let e="";return p[l]&&p[l][c]&&(e=`<br><span style="font-weight:bold;font-size:13px;opacity:0.8;">${p[l][c]}</span>`),`
    <div class="polaroid-card${c==="--color-primary"?" polaroid-primary":""}" data-var="${c}" role="button" tabindex="0" title="Copy ${c}">
      <div class="card-swatch" style="background:var(${c});">
        <div class="swatch-text">${(()=>{const r=String(c).replace(/^--/,"");if(c==="--color-primary-lighter")return"Primary Lighter";if(c==="--color-on-primary-lighter")return"On Primary Lighter";const a=r.match(/^palette-([^-]+)-(\d+)$/);if(a)return a[1].charAt(0).toUpperCase()+a[1].slice(1)+" "+a[2];const t=r.match(/^palette-([^-]+)-([a-zA-Z]+)$/);return t?t[1].charAt(0).toUpperCase()+t[1].slice(1)+" "+t[2]:r.replace(/^color-/,"").split("-").map(function(o){return o.charAt(0).toUpperCase()+o.slice(1)}).join(" ")||r})()}${e}</div>
      </div>
      <div class="card-token-label"><code>${c}</code></div>
  ...
  <details class="flavor-column flavor-${l}" ${$(l)} open style="margin-top:12px">
        ...
        <div class="polaroid-row polaroid-palette" style="margin-bottom:18px;">
          ${x[l].palette.map(c=>y(l,c.replace(/^--/,""),c)).join("")}
        </div>
        <div class="token-list-wrap">
          <table class="token-list">
            ...
            <tbody>
              ${k.map(c=>{let h="",e="";if(/--palette-(vanilla|blueberry|strawberry)-([0-9]+)/.test(c)){const r=c.match(/([0-9]+)$/)[1];["100","200","300"].includes(r)?(e="--color-on-primary-lighter",h="var(--color-on-primary-lighter, #000)"):(e="--color-on-primary-darker",h="var(--color-on-primary-darker, #fff)")}return`
                <tr>
                  <td><code>${c}</code></td>
                  <td><span class="swatch-thumb" data-var="${c}" style="background:var(${c});"><span class="swatch-thumb-text" data-var="${c}" style="color:${h}">Aa</span></span></td>
                  <td class="list-resolved" data-var="${c}">resolving...</td>
                  <td class="list-chain" data-var="${c}">–</td>
                  <td class="list-text-color" data-var="${c}">${e?`<code>${e}</code>`:"computing..."}</td>
                  <td class="list-contrast" data-var="${c}">–</td>
                </tr>
                `}).join("")}
            </tbody>
          </table>
...
}`,...R.parameters?.docs?.source}}};const ie=["Colors","Blueberry","Strawberry","Vanilla"];export{G as Blueberry,H as Colors,I as Strawberry,R as Vanilla,ie as __namedExportsOrder,ce as default};
