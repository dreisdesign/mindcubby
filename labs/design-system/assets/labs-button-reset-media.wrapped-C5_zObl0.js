import"./iframe-BDmmK2bG.js";class a extends HTMLElement{static get observedAttributes(){return["fullwidth","size","variant"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}attributeChangedCallback(){this.render()}render(){const t=this.hasAttribute("fullwidth"),e=this.getAttribute("size")||"large",s=this.getAttribute("variant")||"secondary";this.shadowRoot.innerHTML=`
      <style>
        :host { display: block; }
        labs-button {
          width: ${t?"100%":"auto"};
