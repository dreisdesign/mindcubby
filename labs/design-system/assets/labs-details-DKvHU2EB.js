class s extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.shadowRoot.innerHTML||(this.shadowRoot.innerHTML=`
        <style>
      ...
      `)}}customElements.get("labs-details")||customElements.define("labs-details",s);
