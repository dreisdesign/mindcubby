import"./labs-list-item-DatCmgQS.js";import"./iframe-BlSllhYp.js";import"./preload-helper-PPVm8Dsz.js";class i extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.shadowRoot.innerHTML||(this.shadowRoot.innerHTML=`
        <style>
