import"./labs-list-item-DatCmgQS.js";import"./labs-checkbox-XNLbBo6c.js";import"./labs-dropdown-CYE2Sz68.js";import"./labs-details-DKvHU2EB.js";class e extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.render()}static get observedAttributes(){return["gap"]}attributeChangedCallback(){this.render()}render(){const a=this.getAttribute("gap")||"var(--list-gap, var(--space-sm, 12px))";this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
