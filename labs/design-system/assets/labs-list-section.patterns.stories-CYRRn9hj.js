import"./labs-list-item-DatCmgQS.js";import"./labs-checkbox-XNLbBo6c.js";import"./labs-dropdown-CYE2Sz68.js";import"./labs-details-C9UhCqfF.js";class e extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.render()}static get observedAttributes(){return["gap"]}attributeChangedCallback(){this.render()}render(){const a=this.getAttribute("gap")||"var(--list-gap, var(--space-sm, 12px))";this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
...
\``,...t.parameters?.docs?.source}}};const b=["TodayAndArchived","MultiDayArchive"];export{t as MultiDayArchive,s as TodayAndArchived,b as __namedExportsOrder,d as default};
