import"./labs-list-item-0HSWBBWN.js";import"./labs-checkbox-XNLbBo6c.js";import"./labs-dropdown-Dr0QiVIj.js";import"./labs-details-D8mf-JWN.js";class e extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.render()}static get observedAttributes(){return["gap"]}attributeChangedCallback(){this.render()}render(){const a=this.getAttribute("gap")||"var(--list-gap, var(--space-sm, 12px))";this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
