const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-DwCuIgL2.js","./preload-helper-PPVm8Dsz.js","./iframe-CmhTq6zs.css"])))=>i.map(i=>d[i]);
import{_ as p}from"./preload-helper-PPVm8Dsz.js";class v extends HTMLElement{static get observedAttributes(){return["hide-reset"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}attributeChangedCallback(i,d,b){i==="hide-reset"&&this.render()}get hideReset(){return this.hasAttribute("hide-reset")}set hideReset(i){i?this.setAttribute("hide-reset",""):this.removeAttribute("hide-reset")}render(){const i=this.hideReset;this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          max-width: 340px;
    ...
    `;const d=this.shadowRoot.getElementById("icon-close-btn");d&&d.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))});const b=this.shadowRoot.getElementById("all-apps-btn");if(b){const e="http://localhost:8000/",a="/labs/",h=typeof window<"u"&&window.location&&(window.location.hostname.includes("localhost")||window.location.hostname==="127.0.0.1"),r=async()=>{if(!h){window.open(a,"_blank");return}const n=new AbortController,t=setTimeout(()=>n.abort(),600);try{await fetch(e,{mode:"no-cors",signal:n.signal}),window.open(e,"_blank")}catch{window.open(a,"_blank")}finally{clearTimeout(t)}};b.addEventListener("click",n=>{n.preventDefault(),r()})}const u=this.shadowRoot.getElementById("appearance-btn-slot");if(u){let a=function(){const t=document.documentElement.classList.contains("theme-dark");for(;e.firstChild;)e.removeChild(e.firstChild);const o=document.createElement("labs-icon");o.setAttribute("slot","icon-left"),o.setAttribute("name",t?"bedtime_off":"bedtime"),e.appendChild(o),e.appendChild(document.createTextNode(t?"Turn on light mode":"Turn on dark mode"))};const e=document.createElement("labs-button");e.setAttribute("variant","secondary"),e.setAttribute("size","large"),e.style.width="100%",e.style.justifyContent="flex-start",e.style.margin="0",e.style.position="static",e.id="theme-toggle-btn",e.onclick=()=>{const t=document.documentElement.classList.contains("theme-dark"),o=document.documentElement,m=Array.from(o.classList).find(l=>l.startsWith("flavor-")),c=m?m.replace("flavor-",""):"vanilla",s=t?"light":"dark";p(async()=>{const{applyTheme:l}=await import("./iframe-DwCuIgL2.js").then(f=>f.t);return{applyTheme:l}},__vite__mapDeps([0,1,2]),import.meta.url).then(({applyTheme:l})=>{l({flavor:c,theme:s});try{localStorage.setItem("tracker-theme",s),localStorage.setItem("tracker-flavor",c)}catch{}a()})};const h=new MutationObserver(()=>a());try{h.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]})}catch{}a(),u.appendChild(e),p(()=>import("./labs-flavor-button-D9aMHAuY.js"),[],import.meta.url).then(()=>{const t=document.createElement("labs-flavor-button"),o=Array.from(document.documentElement.classList).find(s=>s&&s.startsWith("flavor-")),c=(o?o.replace("flavor-",""):"blueberry").split("-").map(s=>s.charAt(0).toUpperCase()+s.slice(1)).join(" ");t.setAttribute("label",c),this.shadowRoot.getElementById("flavor-btn")||u.appendChild(t),t.addEventListener("cycle-flavor",s=>{this.dispatchEvent(new CustomEvent("flavor-changed",{detail:s.detail,bubbles:!0,composed:!0}))})}).catch(()=>{});const r=this.shadowRoot.getElementById("reset-all-btn");r&&r.addEventListener("click",t=>{if(r.hasAttribute("disabled")){t.preventDefault(),t.stopPropagation();return}t.preventDefault(),window.confirm("Warning: This will delete all entries. Are you sure you want to continue?")&&(this.dispatchEvent(new CustomEvent("reset-all",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0})))});const n=this.shadowRoot.getElementById("simulate-next-btn");if(n){try{const t=new URL(window.location.href),o=t.searchParams.get("simulate")||t.searchParams.get("simulateNext");(o==="1"||o==="true")&&(n.style.display="")}catch{}n.addEventListener("click",t=>{t.preventDefault(),this.dispatchEvent(new CustomEvent("simulate-next-day",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))})}}}}customElements.define("labs-settings-card",v);
