import"./iframe-DZDCPr1R.js";import"./labs-badge-Cyx4uBIU.js";import"./preload-helper-PPVm8Dsz.js";const y={title:"0. Tokens/Typography",parameters:{viewMode:"docs",options:{panelPosition:"bottom"}}},a={name:"Typography",render(){const i=t=>getComputedStyle(document.documentElement).getPropertyValue(t).trim()||"-",e=(t,r,o,n,l,s=!1)=>{const c=l.match(/\(alias: (--font-size-[^\)]+)\)/),d=c?`<labs-badge variant="secondary" text="${c[1]}" style="margin-left:8px;"></labs-badge>`:"",f=s?`<strong>${t}</strong>`:t,g=s?'<labs-badge variant="primary" text="main" style="margin-left:8px;"></labs-badge>':"",h=o?`var(${o})`:"400",p=n?`var(${n})`:"1.5";let u=l.replace(/\s*\(alias: (--font-size-[^\)]+)\)/,"");return`
        <tr>
