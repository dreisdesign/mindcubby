/**
 * Layout Patterns - Vertical Fill Flex Cascading
 *
 * Guide to building fullscreen editing and detail views by cascading
 * flex-grow through nested components to fill available vertical space.
 */
...
export default {
    title: '4. Patterns/Layouts - Vertical Fill',
    parameters: {
        docs: {
            description: {
                component: `
...
FullscreenEditor.storyName = 'Fullscreen Editor Layout';

export const ComparisonWrong = () => {
    const wrapper = document.createElement('div');
...
ComparisonWrong.storyName = 'Anti-Pattern (Fixed Height)';
...
ComparisonRight.storyName = 'Correct Pattern (Flex Cascading)';
...
KeyPrinciples.storyName = 'Key Principles Guide';
